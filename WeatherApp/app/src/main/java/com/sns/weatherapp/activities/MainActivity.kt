package com.sns.weatherapp.activities
...
import com.sns.weatherapp.R
import com.sns.weatherapp.adapter.MainAdapter
import com.sns.weatherapp.fragment.FragmentNextDays
import com.sns.weatherapp.model.ModelMain
import com.sns.weatherapp.networking.ApiEndpoint
...
class MainActivity : AppCompatActivity(), LocationListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mProgressBar?.setMessage("Displaying data currently...")
                ...
                .getAsJSONObject(object : JSONObjectRequestListener {
                    override fun onResponse(response: JSONObject) {
                        try {
                            ...
                            tvKecepatanAngin.text = "Wind velocity\n $strKecepatanAngin km/h"
                            tvKelembaban.text = "Humidity $strKelembaban %"
                        } catch (e: JSONException) {
                            e.printStackTrace()
                            Toast.makeText(this@MainActivity, "Failed to display header data!", Toast.LENGTH_SHORT).show()
                        }
                    }

                    override fun onError(anError: ANError) {
                        Toast.makeText(this@MainActivity, "No internet network!\n", Toast.LENGTH_SHORT).show()
                    }
                })
    }
